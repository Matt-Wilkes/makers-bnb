...
INSERT INTO spaces (description, name, bedrooms, price, country, city, booked_dates) VALUES ('A horrible place to stay', 'Makers Shed', 1, 5, 'UK', 'Burnley', '{}');
INSERT INTO spaces (description, name, bedrooms, price, country, city, booked_dates) VALUES ('A fantastic holiday destination', 'Makers Villa', 1, 5000, 'USA', 'California', '{}');
